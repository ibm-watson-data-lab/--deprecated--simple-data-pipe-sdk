...
var loggers = {};
	...
	var logPath = function( loggerName ){
		...
		// application home directory (on Bluemix/CF this typically resolves to '/home/vcap/app')
		var homeDir = bluemixHelperConfig.configManager.get('HOME') || '.';
		// log directory
		var logDir = path.resolve( path.join(homeDir,'logs'));
	...
	/**
	 * Returns the global/main logger for this application
	 * @return {Object} an instance of bunyan.createLogger
	 */
	var getGlobalLogger = function() {
		return getLogger('sdp_common');
	};
